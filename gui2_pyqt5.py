...
class ControlPanel(QMainWindow):
    ...
    def start_led(self):
        ...
        if circuits:
            # Send start LED command to Arduino
            self.arduino.write(f'START_LED:{",".join(circuits)}:{time}\n'.encode())
    ...
    def stop_led(self):
        # Send stop LED command to Arduino
        self.arduino.write('STOP_LED\n'.encode())
